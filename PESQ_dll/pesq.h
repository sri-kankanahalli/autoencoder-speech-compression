...
#define Sp  6.910853e-006
#define Sl  1.866055e-001
...
extern const long Fs;
extern const long Downsample;
extern const long Align_Nfft;
extern const float InIIR_Hsos[];
...
void apply_filter ( float * data, long Nsamples, int, const double [][2] );
